...
- May. 2025 - Present | [Rolloo.app](https://www.rolloo.app/): [Nuxt 4, Supabase, Vercel, AI Gateway, Prompts] Founding, researching, full-stack development, prompt engineering, communicating, researching, making everything within new products of [Hyperskill](https://hyperskill.org/);
- Sep. 2023 - May. 2025 | [Hyperskill](https://hyperskill.org/): [Vue.js 3] Frontend developer, mastering tools for content creators, building bridges between the user and AI;
